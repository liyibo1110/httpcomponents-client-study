...
/**
 * @author liyibo
 * @date 2026-04-16 22:19
 */
public class InternalExecRuntime implements ExecRuntime, Cancellable {
    ...
    InternalExecRuntime(final Logger log,
    ...
    @Override
    public void acquireEndpoint(final String id, final HttpRoute route, final Object object, final HttpClientContext context)
            throws IOException {
    ...
    @Override
    public ClassicHttpResponse execute(final String id, final ClassicHttpRequest request, final HttpClientContext context)
