...
import com.github.liyibo1110.hc.core5.http.impl.io.DefaultBHttpClientConnection;
...
/**
 * ManagedHttpClientConnection接口的默认实现。
 * @author liyibo
 * @date 2026-04-21 14:26
 */
public class DefaultManagedHttpClientConnection extends DefaultBHttpClientConnection
    ...
    private static final Logger HEADER_LOG = LoggerFactory.getLogger("com.github.liyibo1110.hc.client5.http.headers");
    private static final Logger WIRE_LOG = LoggerFactory.getLogger("com.github.liyibo1110.hc.client5.http.wire");
